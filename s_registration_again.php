...
<p align ="center">
<div style="color: red;">You didnt enter all needed information, please, try again.</div>

   
    <form action="save_staff.php" class="registration" method="post">
 <h1>Staff Registration
 <span>Please fill all the texts in the fields. Notice that login should be your first name as one letter + your full family name. For example - John Smith will be jsmith.</span>
 </h1>
