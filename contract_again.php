...
<div id="apDiv3">
<div align="center" style="color: red;">You didnt enter all needed information.</div>
...
<input name="group_code" type="text" value="<?php echo $_SESSION['group_code'];?>" maxlength="100" >
</label>
</td>
</tr>
<tr>
...
<input name="programme" type="text" value="<?php echo $_SESSION['programme'];?>" class="text"size="20" maxlength="100">
</label>
</td>
</tr>
<tr>
...
<input name="phone_number" type="text" value="<?php echo $_SESSION['phone_number'];?>" size="20" maxlength="30">
</label>
</td>
<td>
<label><span>Email address*:</span>
<input name="email_address" type="text" value="<?php echo $_SESSION['email_address'];?>" size="20" maxlength="30">
</label>
</td>
</tr>
</table>
...
<textarea style="width:300px; height:32px;" name="place_of_training" cols="80" maxlength="300"><?php echo $_SESSION["place_of_training"]; ?></textarea>
</p>
</td>
<td>
<p>
<label>Phone*:<br /></label>
<input name="phone" type="text" value="<?php echo $_SESSION["phone"]; ?>" size="20" maxlength="30">
</p>
</td>
<td>
<p>
<label>Business ID:<br /></label>
<input name="b_id" type="text" size="18" value="<?php echo $_SESSION["b_id"]; ?>" maxlength="30">
</p>
</td>
</tr>
<tr>
...
<textarea style="width:300px; height:32px;"  name="address"  cols="80" maxlength="300"><?php echo $_SESSION["address"]; ?></textarea>
</p>
</td>
<td>
<p>
<label>Postal code and post office*:<br /></label>
<textarea style="width:350px; height:32px;"  name="post_code_and_office"  cols="80" maxlength="350"><?php echo $_SESSION["post_code_and_office"]; ?></textarea>
</p>
</td>
</tr>
<tr>
...
<input name="contact_person" type="text" size="50" value="<?php echo $_SESSION["contact_person"]; ?>" maxlength="100">
</p>
</td>
<td>
<p>
<label>Contact person's phone number and email address*:<br /></label>
<textarea style="width:350px; height:32px;"  name="con_num_email"   cols="80" maxlength="350"><?php echo $_SESSION["con_num_email"]; ?></textarea>
</p>
</td>
</tr>
<tr>
...
<input name="instructor" type="text" size="50" value="<?php echo $_SESSION["instructor"]; ?>" maxlength="100">
</p>
</td>
<td>
<p>
<label>Instructors phone number and email address*:<br /></label>
<textarea style="width:350px; height:32px;"  name="ins_num_email"  cols="80" maxlength="350"><?php echo $_SESSION["ins_num_email"]; ?></textarea>
</p>
</td>
</tr>
</table>
...
<p>
<label>Contact person*:<br /></label>
<input name="contact_person_luas" type="text" value="<?php echo $_SESSION["contact_person_luas"]; ?>" size="50" maxlength="100">
</p>
</td>
<td>
<p>
<label>Contact person's phone number and email address*:<br /></label>
<textarea style="width:350px; height:32px;"  name="con_num_email_luas"  cols="80" maxlength="350"><?php echo $_SESSION["con_num_email_luas"]; ?></textarea>
</p>
</td>
</tr>
<tr>
...
<p>
<label>Instructor(if not the contact person)*:<br /></label>
<input name="instructor_luas" type="text" value="<?php echo $_SESSION["instructor_luas"]; ?>" size="50" maxlength="100">
</p>
</td>
<td>
<p>
<label>Instructors phone number and email address*:<br /></label>
<textarea style="width:350px; height:32px;"  name="ins_num_email_luas"  cols="80" maxlength="350"><?php echo $_SESSION["ins_num_email_luas"]; ?></textarea>
</p>
</td>
</tr>
</table>
...
<textarea style ="width:450px; height: 32px;" name="type"  cols="80" maxlength ="450"><?php echo $_SESSION["type"]; ?></textarea>
</p>
</td>
<td>
<p>
<label>Scope of training(cr)*:<br /></label>
<input name="scope" type="text" size="20" value="<?php echo $_SESSION["scope"]; ?>" maxlength="30">
</p>
</td>
</tr>
<tr>
...
<label>Learning objectives for practical training defined in the curriculum*:<br /></label>
  ...
  <input type="checkbox" name="learn_object[]" value="Specialize in a certain area">Specialize in a certain area<br />
...
<label>Student's personal learning and development objectives*:<br /></label>
  ...
  <input type="checkbox" name="dev_object[]" value="Three">Three
</td>
</tr>
</table>
<h1></h1>
...
<textarea style="width:480px; height:32px;"  name="add_info"  cols="80" maxlength="480"><?php echo $_SESSION["add_info"]; ?></textarea>
</p>
</td>
<td>
<p>
...
<textarea style="width:480px; height:32px;"  name="tasks_descr"  cols="80" maxlength="480"><?php echo $_SESSION["tasks_descr"]; ?></textarea>
</p>
</td>
</tr>
<tr>
...
<textarea style="width:480px; height:32px;"  name="other_terms" cols="80" maxlength="480"><?php echo $_SESSION["other_terms"]; ?></textarea>
</p>
</td>
</tr>
</table>
